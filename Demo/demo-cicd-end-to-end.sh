...
#   ./Demo/demo-cicd-end-to-end.sh                    # full demo (local gates + optional GitHub + verify)
#   SKIP_GITHUB_DEMO=1 ./Demo/demo-cicd-end-to-end.sh # skip GitHub (PR/workflow) section
#   RUN_LOCAL_GATES_ONLY=1 ./Demo/demo-cicd-end-to-end.sh  # only run local CI gate simulation; exit after
#
# Env:
