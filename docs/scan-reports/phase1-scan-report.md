...
**Pipeline:** Phase 1 CI Gates | **Run:** 22127656048 | **Date:** 2026-02-18T05:21Z
...
2026-02-18T05:20:44Z	INFO	[vulndb] Need to update DB
2026-02-18T05:20:44Z	INFO	[vulndb] Downloading vulnerability DB...
2026-02-18T05:20:44Z	INFO	[vulndb] Downloading artifact...	repo="mirror.gcr.io/aquasec/trivy-db:2"
29.50 MiB / 85.54 MiB [--------------------->_______________________________________] 34.49% ? p/s ?75.55 MiB / 85.54 MiB [----------------------------------------------------->_______] 88.32% ? p/s ?85.54 MiB / 85.54 MiB [----------------------------------------------------------->] 100.00% ? p/s ?85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 93.37 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 93.37 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 93.37 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 87.35 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 87.35 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 87.35 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 81.71 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 81.71 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 81.71 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 76.44 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 76.44 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [---------------------------------------------->] 100.00% 76.44 MiB p/s ETA 0s85.54 MiB / 85.54 MiB [-------------------------------------------------] 100.00% 29.51 MiB p/s 3.1s2026-02-18T05:20:48Z	INFO	[vulndb] Artifact successfully downloaded	repo="mirror.gcr.io/aquasec/trivy-db:2"
2026-02-18T05:20:48Z	INFO	[vuln] Vulnerability scanning is enabled
2026-02-18T05:20:48Z	INFO	[secret] Secret scanning is enabled
2026-02-18T05:20:48Z	INFO	[secret] If your scanning is slow, please try '--scanners vuln' to disable secret scanning
2026-02-18T05:20:48Z	INFO	[secret] Please see https://trivy.dev/docs/v0.69/guide/scanner/secret#recommendation for faster secret detection
2026-02-18T05:20:49Z	INFO	Detected OS	family="alpine" version="3.19.9"
2026-02-18T05:20:49Z	INFO	[alpine] Detecting vulnerabilities...	os_version="3.19" repository="3.19" pkg_num=15
2026-02-18T05:20:49Z	INFO	Number of language-specific files	num=1
2026-02-18T05:20:49Z	INFO	[gobinary] Detecting vulnerabilities...
2026-02-18T05:20:49Z	WARN	Using severities from other vendors for some vulnerabilities. Read https://trivy.dev/docs/v0.69/guide/scanner/vulnerability#severity-selection for details.
2026-02-18T05:20:49Z	WARN	This OS version is no longer supported by the distribution	family="alpine" version="3.19.9"
2026-02-18T05:20:49Z	WARN	The vulnerability detection may be insufficient because security updates are not provided
